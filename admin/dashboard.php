...
{
?>
											Total Users :<?php echo htmlentities($num_rows);  } ?>				</a>
											</p>
										</div>
									</div>
								</div>
...
{
?>
											Total Doctors :<?php echo htmlentities($num_rows1);  } ?>				</a>
...
{
?>
											Total Queries :<?php echo htmlentities($num_rows22); } ?>	</a>
											</p>
										</div>
									</div>
								</div>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-paper-plane fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Send Payment Request</h2>

											<p class="links cl-effect-1">
												<a href="send-payment-request.php">
													Send Request
												</a>
											</p>
										</div>
								...
								<div class="col-sm-4" style="background: white;">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body" >
											...
											<h2 class="StepTitle">Payment Reports</h2>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Settings</h2>
